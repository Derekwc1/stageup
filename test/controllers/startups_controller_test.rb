...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { equity: @startup.equity, name: @startup.name, pitch: @startup.pitch, position: @startup.position, stage: @startup.stage }
    end
  ...
  test "should update startup" do
    patch :update, id: @startup, startup: { equity: @startup.equity, name: @startup.name, pitch: @startup.pitch, position: @startup.position, stage: @startup.stage }
    assert_redirected_to startup_path(assigns(:startup))
  end
